...
public class ClassSearcher2 {

    protected static final Logger log = Logger.getLogger(ClassSearcher2.class);
    ...
    public static ClassSearcher2 of(Class<?> target) {
        return new ClassSearcher2(target);
    }
        ...
        if (!baseDir.exists() || !baseDir.isDirectory()) {
            ...
            for (int i = 0; i < filelist.length; i++) {
                ...
                if (readfile.isDirectory()) {
                    ...
                    if (ClassSearcher2.wildcardMatch(targetFileName, tempName)) {
                        String classname;
    ...
    public ClassSearcher2(Class<?> target) {
        this.target = target;
    }

    public ClassSearcher2 injars(List<String> jars) {
        if (jars != null) {
    ...
    public ClassSearcher2 inJars(String... jars) {
        if (jars != null) {
            for (String jar : jars) {
                includeJars.add(jar);
            }
    ...
    public ClassSearcher2 classpath(String classpath) {
    ...
    public <T> List<Class<? extends T>> search() {
        ...
        System.out.println(target + "   " + classFileList);
    ...
    public ClassSearcher2 includeAllJarsInLib(boolean includeAllJarsInLib) {
        this.includeAllJarsInLib = includeAllJarsInLib;
        return this;
    }

    public ClassSearcher2 libDir(String libDir) {
        this.libDir = libDir;
        return this;
    }
